defmodule PlannerWeb.UserControllerTest do
  ...
  @create_attrs %{email: "some email", first_name: "some first_name", image: "some image", last_name: "some last_name", password_hash: "some password_hash", user_name: "some user_name"}
